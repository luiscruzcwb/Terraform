...
resource "aws_dynamodb_table" "ddbtable" {
    name = var.table_name #variables #.tfvars
    hash_key = "id"
...
resource "aws_s3_bucket" "s3-bucket-luiscruz" {
  bucket = var.s3_bucket_name #variables #.tfvars

  tags = {
    Name        = "dio-s3-bucket-luiscruz"
    Environment = "Dev"
  }
...
resource "aws_lambda_function" "registerLambda" {
    ...
    s3_bucket = var.s3_bucket_name #variables #.tfvars
